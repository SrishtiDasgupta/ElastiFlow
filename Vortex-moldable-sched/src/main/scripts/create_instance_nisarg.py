...
# from config.constants import SIMULATE, COLD_START_TIME
...
def launchInstance(instanceName: str, count):
    ...
    instances = ec2.create_instances(
        ImageId='ami-0becc523130ac9d5d', #'ami-04542995864e26699',
    ...
    for instance in instances:
        ...
        local_script = '/Users/srishtidasgupta/PhD/PhD/PhD_Codebase/Vortex-mid/Vortex-moldable-sched/src/main/scripts/on_demand_setup.sh'
        ...
        print(f"On demand set up in {time.time() - start}")
