...
def setupInstanceHPO(ssh, instance_role: str, instance_ip: str):
    ...
    try:
        ...
        if instance_role == 'executor':
            ...
            local_script = '/home/ubuntu/Vortex/src/main/scripts/on_demand_setup_HPO_executor.sh'
        else:  # worker
            # Setup worker instance
            remote_script = '/home/ubuntu/hpo_worker_setup.sh'
            local_script = '/home/ubuntu/Vortex/src/main/scripts/on_demand_setup_HPO_worker.sh'
