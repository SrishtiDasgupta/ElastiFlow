#!/bin/bash
# ============================================================================
# Profile all 36 combinations on g5.xlarge cluster at IMAGE_SIZE=64
#
...
#   bash profile_all_g5.sh
#
# Output: /fsx/hyperparameter_test/g5_img64.jsonl (consolidated)
# ============================================================================
...
OUTPUT_FILE="$SCRIPT_DIR/g5_img64.jsonl"
MEASUREMENT_DIR="$SCRIPT_DIR/measurements_g5"
IMAGE_SIZE=64
