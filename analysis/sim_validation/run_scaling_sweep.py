...
Usage:
    python analysis/sim_validation/run_scaling_sweep.py \
        --N 10,25,50,100 \
        --replicates 1 \
        --out analysis/sim_validation/out/sweep_results.csv
...
def main():
    ...
    ap.add_argument("--out", default=str(REPO / "analysis/sim_validation/out/sweep_results.csv"))
    ap.add_argument("--log-dir", default=str(REPO / "analysis/sim_validation/out/sweep_logs"))
