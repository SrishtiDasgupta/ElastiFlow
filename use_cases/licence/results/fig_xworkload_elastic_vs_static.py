...
Sections 9.2-9.4 use. Nothing here is hardcoded.
  ...
  SeisSol   N=400  ../../seissol/results/plain_results_per_run.json
...
# ------------------------------------------------------------------ datasets
PLAIN = json.loads((ROOT / 'use_cases/seissol/results/plain_results_per_run.json').read_text())
HPO = json.loads((ROOT / 'use_cases/hpo/results/plots/total_cost_per_run.json').read_text())
